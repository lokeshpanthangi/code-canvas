            ...
            <article className="flex-1 min-w-0 max-w-4xl">
              ...
              <section id="overview" className="mb-16">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  ...
                  intelligently, and streams text in real time — all powered by <InlineCode>LangChain</InlineCode> and 
              ...
              <section id="what-is-chatbot" className="mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
                  <div className="p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                    ...
                    <div className="text-sm text-muted-foreground">Accept user input — a question, a command, or casual conversation</div>
                  </div>
              ...
              <section id="how-memory-works" className="mb-16">
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  LLMs are <strong className="text-foreground">stateless</strong> — every API call is independent.
                ...
                <Callout type="info" title="Token limits">
                  ...
                  model's context window. Strategies like summarisation or sliding-window trimming can help — 
              ...
              <section id="prerequisites" className="mb-16">
                ...
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start gap-3">
                    ...
                    <span><strong className="text-foreground">Python 3.9+</strong> — installed on your machine</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <ChevronRight className="w-5 h-5 text-teal-500 shrink-0 mt-0.5" />
                    <span><strong className="text-foreground">An OpenAI API key</strong> — sign up at <InlineCode>platform.openai.com</InlineCode> and generate a key</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <ChevronRight className="w-5 h-5 text-teal-500 shrink-0 mt-0.5" />
                    <span><strong className="text-foreground">Basic Python knowledge</strong> — variables, functions, and f-strings</span>
                  </li>
                </ul>

                <Callout type="tip" title="No ML experience needed!">
                  You don't need to know how LLMs work internally. We're treating the model as a service — you
...
pip install langchain langchain-openai python-dotenv`}
                ...
                <Callout type="info" title="Why these packages?">
                  <strong>langchain</strong> — provides chains, memory, prompt templates, and the glue to
                  connect everything together.<br />
                  <strong>langchain-openai</strong> — the official LangChain ↔ OpenAI bridge that gives us 
                  <InlineCode>ChatOpenAI</InlineCode>.<br />
                  <strong>python-dotenv</strong> — loads your API key from a <InlineCode>.env</InlineCode> file
...
print("✓ API key loaded successfully")`}
              ...
              <section id="implementation" className="mb-16">
                ...
                {/* Step 1 — Basic Chat Call */}
                <div id="basic-chat" className="mb-12">
                  <h3 className="text-xl font-semibold text-foreground mb-4">Step 1 — Basic Chat Call</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
...
print(response.content)`}
                  ...
                  <p className="text-muted-foreground leading-relaxed mt-4">
                    That's it — one function call and you've got GPT talking back. But notice we sent a raw
                ...
                <div id="prompt-template" className="mb-12">
                  <h3 className="text-xl font-semibold text-foreground mb-4">Step 2 — Prompt Templates</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
...
print(response.content)`}
                  ...
                  <OutputBlock
                    output={`Hey! 👋 I'm CodeBot. I can help you with:
• Explaining programming concepts
• Debugging code snippets
• Suggesting best practices
• Walking you through projects step by step
...
What would you like to learn today?`}
                ...
                <div id="adding-memory" className="mb-12">
                  <h3 className="text-xl font-semibold text-foreground mb-4">Step 3 — Adding Memory</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    Right now our chain has no memory — every call is independent. Let's fix that by plugging
...
# Configuration — identifies the session
...
print("Bot:", r2.content)`}
                  ...
                  <OutputBlock
                    output={`Bot: Nice to meet you, Alex! 👋 How can I help you today?
Bot: Your name is Alex! What would you like to work on?`}
                  ...
                  <Callout type="tip" title="Multiple sessions">
                    ...
                    session has its own isolated history — just like real chat threads.
                  </Callout>
                </div>

                {/* Step 4 — Streaming Responses */}
                <div id="streaming" className="mb-12">
                  <h3 className="text-xl font-semibold text-foreground mb-4">Step 4 — Streaming Responses</h3>
                  <p className="text-muted-foreground leading-relaxed mb-4">
...
print()  # newline at the end`}
                  ...
                  <p className="text-muted-foreground leading-relaxed mt-4">
                    ...
                    LangChain handles chunking automatically — each <InlineCode>chunk.content</InlineCode> is a small 
...
Bot: Hi Alex! 👋 Great to meet you. Python is an awesome first language — it's
...
Goodbye! 👋`}
                ...
                <p className="text-muted-foreground leading-relaxed mt-4">
                  ...
                  That's the memory system at work — every message you and the bot exchange is stored in 
...
├── chatbot.py        # The complete chatbot (80 lines)
└── venv/             # Virtual environment (optional)`}
              ...
              <section id="next-steps" className="mb-16">
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">
                  Congratulations — you've built a fully functional chatbot with memory and streaming!
